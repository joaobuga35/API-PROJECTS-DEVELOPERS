...
import {iProjDev, iProjDevResult, iProjTech, iProjTechResult, iTechs, iTechsProjReadResult} from '../interfaces/interface.projAndDev'
...
export const createTech = async (req: Request, resp: Response): Promise<Response> => {
...
export const deleteTechOnProject = async (req: Request, resp: Response): Promise<Response> => {
    const idProj: number = Number(req.params.id)
