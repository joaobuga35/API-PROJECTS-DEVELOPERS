...
import {createTech, deleteTechOnProject, readDeveloperProjects} from './logics/projects.tech.logics'
import {verifyTechId, verifyTechNameExists, verifyTechNameForDelete} from './middlewares/middlewares.tech'
...
app.post('/projects/:id/technologies',ensureIdProjectExists, verifyTechNameExists, createTech)
app.delete('/projects/:id/technologies/:name',ensureIdProjectExists,verifyTechNameForDelete,verifyTechId,deleteTechOnProject)
